                                    ...
                                    @foreach($products as $product)
										<tr>
											...
											<td>
												...
												<a href="admin/product/delete/{{$product->id}}" onclick="return confirm('Bạn có chắc chắn muốn xóa sản phẩm {{$product->name}} không?')" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
											</td>
										</tr>
                                    @endforeach
									</tbody>
