                                            ...
                                            <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane fade @if($i==1) active @endif in" id="tab{{$attribute->id}}">
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                @foreach($attribute->values as $value)
                                                                    <td> <input class="form-check-input" type="checkbox" name="attr[{{$attribute->id}}][]"
                                                                                value="{{$value->id}}"> </td>
                                                                @endforeach
                                                                </tr>
                                                            </tbody>
                                                        ...
                                                        <div class="form-group">
                                                            <form action="admin/product/add-value" method="post">
                                                                ...
                                                                @if($errors->has('attr_value'))
                                                                    <div class="alert alert-danger">
                                                                        <strong>{{$errors->first('attr_value')}}</strong>
                                                                    </div>
                                                                @endif
                                                                <input type="hidden" name="attr_id" value="{{$attribute->id}}">
                                                                <input style="border: 1px solid; margin-bottom: 10px;" name="attr_value" type="text" class="form-control"
                                                                       aria-describedby="helpId" placeholder="">
                                                                <div> <button name="add_value" type="submit">Thêm</button></div>
                                                            </form>
                                                        </div>
                                                    </div>
                                                    <?php $i=2;?>
                                                ...
                                                <div class="tab-pane fade" id="tab-add">
                                                    <form action="admin/product/add-attr" method="post">
                                                        ...
                                                        <button type="submit" name="add_attr" class="btn btn-success"> <span
