                    ...
                    <div class="col-xs-10 text-right menu-1">
                        <ul>
                            ...
                            <li class="has-dropdown">
                                <a href="store/products">Cửa hàng</a>
                                <ul class="dropdown">
                                    <li><a href="store/cart">Giỏ hàng</a></li>
                                    <li><a href="store/checkout">Thanh toán</a></li>

                                </ul>
                            </li>
                            <li><a href="about-us">Giới thiệu</a></li>
                            <li><a href="contact">Liên hệ</a></li>
                            <li><a href="store/cart"><i class="icon-shopping-cart"></i> Giỏ hàng [0]</a></li>
                        </ul>
                    </div>
                </div>
            </div>
