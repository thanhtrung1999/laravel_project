...
@section('content')
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6">
						<div class="row">
							<div class="col-md-6">
								<a href="" class="f-product-2" style="background-image: url(frontend/images/item-2.jpg);">
									<div class="desc">
										<h2> <br>Váy <br> Mới</h2>
									</div>
								</a>
							...
							<div class="col-md-6">
								<a href="" class="f-product-2" style="background-image: url(frontend/images/item-4.jpg);">
									<div class="desc">
							...
							<div class="col-md-12">
								<a href="" class="f-product-2" style="background-image: url(frontend/images/item-3.jpg);">
									<div class="desc">
		...
		<div id="colorlib-intro" class="colorlib-intro" style="background-image: url(frontend/images/cover-img-1.jpg);"
		...
		<div class="colorlib-shop">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-3 text-center">
						<div class="product-entry">
							<div class="product-img" style="background-image: url('backend/img/{{$product_new->img}}');">
