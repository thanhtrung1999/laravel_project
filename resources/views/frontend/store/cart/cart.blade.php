						...
						<div class="product-cart">
							<div class="one-forth">
								<div class="product-img">
									<img class="img-thumbnail cart-img" src="frontend/images/item-6.jpg">
								</div>
								...
								<div class="col-md-3 col-md-push-1 text-center">
									<div class="total">
										...
										<div class="grand-total">
											...
											<a href="store/checkout" class="btn btn-primary">Thanh toán <i class="icon-arrow-right-circle"></i></a>
										</div>
									</div>
								</div>
							</div>
